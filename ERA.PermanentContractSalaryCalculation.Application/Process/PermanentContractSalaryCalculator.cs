    ...
    public class PermanentContractSalaryCalculator : IPermanentContractSalaryCalculator
    {
            ...
            PermanentContractSalaryCalculationContext context)
        {
            ...
            var result = builder
                ...
                .CalculateTaxBase(copyrightLawsPercent, builder.Result.TotalSocialInsurance, context.Parameters.EmploymentRelationshipTaxDeductibleExpensesSetting.Amount)
